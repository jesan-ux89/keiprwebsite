...
export default function SettingsPage() {
  ...
  return (
    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
      ...
      {/* Spending Budgets Section (Full Dollar Tracking) */}
      <Card style={{ marginBottom: '1.5rem' }}>
        <button
          ...
          style={{
            ...
            padding: 0,
            cursor: 'pointer',
            marginBottom: expandedSection === 'spending' ? '1.5rem' : 0,
          }}
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          ...
          <ChevronRight
            ...
            style={{
              color: colors.textMuted,
              transform: expandedSection === 'spending' ? 'rotate(90deg)' : 'none',
              transition: 'transform 0.2s ease',
            }}
          />
        </button>
        ...
        {expandedSection === 'spending' && (
          <>
            {!isPro ? (
              <div style={{ padding: '1rem', borderRadius: 12, border: `1px dashed ${colors.cardBorder}`, textAlign: 'center' }}>
                <p style={{ color: colors.textMuted, fontSize: '0.95rem', margin: '0 0 0.5rem 0' }}>
                  Spending budgets are available on the Pro plan.
                </p>
                <Button variant="primary" size="sm" onClick={() => toggleSection('subscription')}>
                  Upgrade to Pro
                </Button>
              ...
              <>
                <p style={{
                  ...
                  Set monthly spending budgets by category to track your discretionary spending alongside your bills.
                </p>
                <p style={{ color: colors.textMuted, margin: '0 0 1rem 0', fontSize: '0.9rem' }}>
                  Spending budgets coming soon!
                </p>
              </>
            )}
          </>
